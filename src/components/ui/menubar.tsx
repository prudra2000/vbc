...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-9 items-center space-x-1 rounded-md ",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center text-sm font-medium outline transition-all duration-300 data-[state=open]:outline-blue-500 data-[state=open]:outline-2 ",
      className
    )}
    {...props}
  />
